# **Aluno [1200630](../)** - US-19 - Resgatar Créditos de um Utilizador
# 1. Requisitos

**US-19** 

COMO um cliente, QUERO poder ver todos os créditos ganhos em pedidos anteriores, ASSIM QUE eu verifico se posso fazer algum uso deles

Critérios de aceitação:
1. Dado que o preço de um pedido é superior a # €
Quando um pedido foi feito
Então # créditos devem ser creditados na minha conta (é este o responsável ??)
