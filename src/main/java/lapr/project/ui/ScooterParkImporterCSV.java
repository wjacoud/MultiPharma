...
public class ScooterParkImporterCSV implements Importer{
    
    private final static String TEMPLATE_HEADER = "addressID;pharmacyID;voltage;spots_with_charges;spots_without_charges";
    private final static String FILE_SEPARATOR = ";";
    private final static String FILE_COMMENT = "#";
    private final static int EXPECTED_NUMBER_OF_COLUMNS = 5;
