...
public class ClientImporterCSV implements Importer{
    
    private final static String TEMPLATE_HEADER = "name;nif;credit;country;district;locality;zip_code;latitude;longitude;e-mail;pass;number;cvv;validate";
    private final static String FILE_SEPARATOR = ";";
    private final static String FILE_COMMENT = "#";
    private final static int EXPECTED_NUMBER_OF_COLUMNS = 14;
