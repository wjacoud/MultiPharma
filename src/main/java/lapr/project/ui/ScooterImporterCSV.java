...
public class ScooterImporterCSV implements Importer{
    
    private final static String TEMPLATE_HEADER = "backpack capacity;pharmacy_id;scooter_type_id";
    private final static String FILE_SEPARATOR = ";";
    private final static String FILE_COMMENT = "#";
    private final static int EXPECTED_NUMBER_OF_COLUMNS = 3;
