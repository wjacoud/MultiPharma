...
public class EdgeTest {
    ...
    public void testEquals() {
        ...
        // should be equal to a clone"
        assertTrue(instance.equals(instance.clone()));

        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex1);

        // "should not be equal to otherEdge"
    ...
    public void testToString() {
        ...
        Edge<String, String> otherEdge = new Edge<>();
        otherEdge.setVDest(vertex1);
        System.out.println(otherEdge.toString().trim());
        
        String expResult2 = "(edge1) - 1.0 - Vertex1";
