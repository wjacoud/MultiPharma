...
public class EdgeImporterCSV implements Importer{
    
    private final static String TEMPLATE_HEADER = "address_id1;address_id2";
    private final static String FILE_SEPARATOR = ";";
    private final static String FILE_COMMENT = "#";
    private final static int EXPECTED_NUMBER_OF_COLUMNS = 2;
