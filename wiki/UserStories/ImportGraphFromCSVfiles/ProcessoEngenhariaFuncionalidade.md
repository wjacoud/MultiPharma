# **Aluno [1171317](../)** - US-34 - Importar grafo a partir de ficheiros CSV
...
**US-34** 
As an Administrator,
I want the system to be able to read address and roads from CSV files
so that I can have a 'map' with all the possible paths
...
Esta US dependente da **TASK-170 Establish vertex file and edges files format & Create Files**, uma vez que serão estes os ficheiros a serem lidos por esta US, de forma a construir o grafo. Quando à implementação, esta é precedida pela criação de uma nova entidade, Link, não de negócio, responsável por guardar atributos que classificam as condições de um segmento entre duas moradas. 
